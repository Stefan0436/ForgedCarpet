...
import carpet.forge.mixin.PlayerChunkMapEntryAccessor;
import carpet.forge.mixin.WorldServerAccessor;
...
public class CommandFillBiome extends CommandCarpetBase
{
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        ...
        for (int x = minX; x <= maxX; x++)
        {
            ...
            {
                Chunk chunk = world.getChunkFromBlockCoords(pos.setPos(x, 0, z)); // Stefan0436: changed to getChunkFromBlockCoords
